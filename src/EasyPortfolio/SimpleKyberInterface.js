...
async function myNewWay(myWeb3, rawTxs, approvals, trades, txToCompleteCallback) {
    ...
    for(var i = 0; i < approvals.length; i ++) {
        ...
        if(i === approvals.length - 1) {
            ...
            doSendTransaction(myWeb3, tx, theApproval, txToCompleteCallback)
        }
        counter ++;
    }
    ...
    for(var i = 0; i <trades.length; i ++) {
        ...
        doSendTransaction(myWeb3, tx, theTrade, txToCompleteCallback)
        counter ++;
    }

}

function increaseNonse(rawTxs) {
